...
const data: BriefData = {
  ...
  flash:
    'The International Maritime Organization paused its Hormuz evacuation plan — the initiative to extract the ~11,000 seafarers stranded aboard vessels in the Middle East Gulf — citing the need to reconfirm that "the necessary safety guarantees continue to be in place" after Iran\'s Thursday vessel strike, with IMO Secretary-General Arsenio Dominguez confirming the suspension (CNBC, NPR, Al Jazeera). The evacuation plan was announced two days after the MoU\'s signing as its principal humanitarian deliverable; the pause converts a flagship confidence-building measure into a hostage of the IRGC\'s route-control warning and makes the IMO the day\'s most significant institutional exit (TIME, IMO.org). A trickle of cargo traffic continued through the Strait on Friday and oil held above $75; no Lebanon, nuclear, or casualty developments materially changed the morning brief\'s read (NBC News). Analytical judgment: escalation direction and ceasefire probability (70, mixed) are unchanged, but the IMO pause is new evidence for tomorrow that the maritime-calm argument cannot rest on cargo-flow numbers alone — the institution charged with coordinating the humanitarian dimension of Hormuz normalization has withdrawn its safety certification, which tomorrow\'s morning brief should absorb as a secondary maritime-ledger casualty alongside the oil-price reversal. (CNBC, NPR, Al Jazeera, TIME, NBC News, IMO — accessed 2026-06-26T10:00Z.)',
  casualtyNotes: {
    us:
