...
const data: BriefData = {
  escalation: {
    ...
    rationale: {
      direction:
        "Day 74 converts Sunday's 'TOTALLY UNACCEPTABLE' rupture into a Monday hardening across rhetorical, substantive, and market channels simultaneously. Trump escalates the rejection to 'massive life support,' calls Iran's response 'garbage,' and gives the survival odds at 'approximately a 1% chance of living' — public, presidential, and committed at a level Sunday's Truth Social statement was not. Iran's substantive counter-position firms: an Iranian official tells Al Jazeera Iran is ready to dilute 60% HEU to 3.7% and 20% under IAEA supervision but rejects any transfer abroad and rejects a 20-year enrichment halt. Pezeshkian declares Iran will 'never bow down to the enemy'; Baqaei adds Iran is 'prepared to fight whenever it is necessary.' Probability falls 14 → 11.",
      risk7d:
        "Seven-day risk holds critical and compresses sharply. Trump-Xi summit at T-minus-2 inherits a doubly-broken process — Sunday's rejection has hardened into Monday's 'garbage' / '1% chance' framing. Bessent's 'join us in this international operation' Hormuz-opening pitch lands in Beijing against Iran's public refusal to transfer HEU. Brent settles $104.21 Monday (+2.9%); WTI $98.07 (+2.8%); Kalshi assigns >60% odds to US gasoline crossing $5/gallon — gasoline-driven retail-political pressure on Trump compresses to a 4-6 week horizon. The IRGC 'missiles locked' threat from Sunday carries; CENTCOM blockade enforcement continues at the 58+ vessel floor; the kinetic-tail $130-170 ceiling becomes priced reality rather than tail risk.",
      spillover:
        "Spillover degrades to critical and broadens. The GCC bloc operationalizes Sunday's three-state attack pattern (Qatar cargo ship + UAE-attributed Iranian UAVs + Kuwait dawn drones) into a coordinated condemnation chain: Saudi MOFA condemns 'treacherous targeting' of UAE/Qatar/Kuwait; Bahrain denounces 'continued blatant and unjustified Iranian attacks'; UAE expresses 'full solidarity' with Kuwait; GCC Secretary General Albudaiwi calls Iran's behavior a 'treacherous approach' seeking to 'destabilise regional security.' The US-Bahrain UNSC draft on Hormuz freedom of navigation now sits under fresh diplomatic substrate. Lebanon Health Ministry: +17 KIA past 24 hours (cumulative ~2,724+); IDF strikes Kfar Tibnit; two Lebanese medics reported killed Monday. Senate returns; Murkowski AUMF window active.",
    },
  },
  events: [
    {
      ...
      direction: 'escalating',
      importance: 'pivotal',
      source: "Al Jazeera / CNN / CNBC / Bloomberg / Washington Post / Time / NBC News",
      event: "Trump escalates Sunday's 'TOTALLY UNACCEPTABLE' to Monday's 'massive life support' / 'garbage' / '1% chance of living' — ceasefire framework publicly euthanized",
      summary:
    ...
    },
    {
      ...
      direction: 'escalating',
      importance: 'pivotal',
      source: "Iran International / Business Standard / Investing Live / Pravda EN / Al Jazeera",
      event: "Iran specifies HEU position: 'ready to dilute' 60% stockpile to 3.7%/20% under IAEA supervision, rejects transfer abroad, rejects 20-year enrichment halt — public reservation price hardens",
      summary:
    ...
    },
    {
      ...
      impact:
        "The framework-collapse risk channel that yesterday's brief identified as adding a premium to the energy-transmission stack today becomes a priced market reality. Brent above $103 is now the working floor through the Trump-Xi window; the kinetic-tail $130-170 ceiling becomes increasingly likely rather than tail risk. The Kalshi gasoline >$5/gallon 60%+ probability compresses US retail-political pressure on Trump to a 4-6 week horizon — by mid-June, Trump faces a structurally higher domestic-political cost of holding the rejection line.",
    },
    {
      id: 5,
      direction: 'escalating',
      importance: 'high',
      source: "Voice of Emirates / Tribune India / Gulf News / Saudi MOFA / Bahrain MOFA / GCC SG Albudaiwi",
      event: "GCC bloc operationalizes Sunday's three-state attack pattern into coordinated condemnation chain — Saudi/Bahrain/UAE/Kuwait/GCC-SG converge on Iran-attribution",
      summary:
    ...
    },
    {
      ...
      direction: 'escalating',
      importance: 'medium',
      source: "Al Jazeera live / NBC News / Lebanon Health Ministry / IDF",
      event: "Lebanon Health Ministry: +17 KIA past 24 hours (cumulative ~2,724+); IDF strikes Kfar Tibnit; two Lebanese medics reported killed Monday — Lebanon track structurally coupled to MOU collapse",
      summary:
    ...
    },
    {
      ...
      direction: 'mixed',
      importance: 'medium',
      source: "Murkowski Senate Floor / The Hill / KTOO",
      event: "Senate returns Monday — Murkowski's AUMF window opens; she pledged authorization measure absent 'credible plan' from White House; Thune scheduling and privilege obstacles carry",
      summary:
    ...
    },
    {
      ...
      impact:
        "Beijing at T-minus-2 inherits a publicly euthanized process plus a Sunday-three-state-Gulf-attack coalition condemnation plus Brent +2.9% Monday plus Murkowski Senate floor activation. Xi's structural incentive to pre-position Chinese support for a US-Iran framework that Trump has publicly labeled 'garbage' / '1% chance' collapses — the political cost of investing capital in a framework Washington has already euthanized exceeds the upside of being seen as a constructive intermediary. Expectations for any substantive Trump-Xi Iran deliverable compress sharply; the summit's tariff and rare-earth tracks now compete with an Iran agenda item that has no clear resolution path.",
    },
  ],
  casualties: {
    us: {
      cumulative: 'KIA: 15 (13 combat + 2 noncombat) · WIA: 400+',
      delta: '+0 confirmed KIA Monday',
      status:
        "No new US casualties confirmed Monday. IRGC 'missiles locked' threat from Sunday carries with pre-positioned strike packages against US targets and ships awaiting orders. CENTCOM blockade enforcement continues at 58+ vessels redirected since April 13; four Iranian-flagged tankers disabled cumulatively (Sea Star III and Sevda May 8). Trump escalates rejection: 'massive life support' / 'garbage' / '1% chance of living.' Bessent asks China to 'join us in this international operation' to reopen Hormuz at Trump-Xi T-minus-2. Senate returns; Murkowski AUMF window opens with Tillis/Curtis/Young/Hawley as positioning Republicans.",
    },
    israel: {
      cumulative: 'KIA: 47 · WIA: 8,600+',
      delta: '+0 KIA / +0 new WIA Monday (Saturday +3 WIA from Hezbollah explosive drones carries)',
      status:
        "No new Israeli casualties confirmed Monday. IDF strikes Kfar Tibnit and southern Lebanon villages despite ceasefire framework. Two Lebanese medics reported killed Monday per AJ live. IDF nine-village evacuation order in southern Lebanon carries from Day 72. Saturday's +3 reservist WIA from Hezbollah explosive drones near border carries. Iron Beam laser first-intercept claims from earlier in week carry. Day 72 IDF operational-tempo pattern persists.",
    },
    iran: {
      cumulative: "LMO 'nearly 3,400' KIA · HRANA 3,636+ (1,701 civ + 1,221 mil + 254+ children) · Hengaw 6,620+ mil · 3.2M displaced",
      delta: 'No new figures Monday',
      status:
        "No new casualty figures Monday. Iranian official tells Al Jazeera Iran 'ready to dilute' 60% HEU to 3.7%/20% under IAEA supervision; rejects transfer abroad; rejects 20-year enrichment halt; proposes 30-day talks. Pezeshkian: Iran will 'never bow down to the enemy.' FM spokesperson Baqaei: 'prepared to fight whenever it is necessary.' Araghchi activates Islamabad-Muscat-Moscow 'timely tour.' Rial continues toward fresh all-time low ground after Monday open with Brent +2.9% and Trump 'garbage' rhetoric.",
    },
    other: {
      cumulative: 'Lebanon MOH: ~2,724+ KIA / 8,200+ WIA · Iraq: 117+ · Gulf states: 32+ · UAE: 14+9 wounded cumulative · Qatar: +0 Sunday (cargo ship fire, no casualties)',
      delta: 'Lebanon: +17 KIA past 24 hours per AJ Monday liveblog (cumulative ~2,724+); Sunday Gulf-state incidents from Day 73 carry',
      status:
        "Lebanon: Health Ministry +17 KIA past 24 hours per AJ Monday liveblog; IDF strikes Kfar Tibnit; two Lebanese medics reported killed Monday. Qatar: Sunday's 23nm NE Doha cargo-ship drone strike carries (fire extinguished, no casualties, no claim). UAE: Sunday's two UAVs 'launched from Iran' carries. Kuwait: Sunday's hostile drones at dawn carry. GCC bloc operationalizes Saudi/Bahrain/UAE/Kuwait condemnation chain. Hormuz: zero transits since May 4 per Lloyd's carries; 58+ vessels redirected.",
    },
  },
  exec:
  ...
  implications: [
    {
      title: "Trump's 'garbage' / '1% chance' escalation past Sunday's 'TOTALLY UNACCEPTABLE' formalizes the framework break on the eve of Beijing — the convergence path is closed before Xi arrives at the table",
      body:
    ...
    {
      title: "Iranian leadership formalizes dual-track defiance; Araghchi's multi-capital salvage circuit is resilience signaling rather than a convergence channel; energy markets price the operational reality",
      body:
    ...
    {
      title: "GCC condemnation chain + Lebanon MOH +17 + Murkowski AUMF push widen Taiwan procurement exposure on three independent channels — Beijing inherits a multilateral case Bessent did not have last week",
      body:
