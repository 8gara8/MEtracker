  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, marginTop: 12 }}>
        ...
        {brief.sources && (
          <div>
            <window.SectionRule theme={theme} number={7} label="Sources" right={`${brief.sources.length} citations`} />
      ...
      {/* Casualties — placed toward the end per editorial preference */}
      <div>
        <window.SectionRule theme={theme} number={8} label="Casualties snapshot" right="Cumulative · ±24–48h Δ" />
