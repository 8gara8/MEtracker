...
import day124 from '@/content/briefs/2026-07-01-day-124.data';
import day125 from '@/content/briefs/2026-07-02-day-125.data';
import day126 from '@/content/briefs/2026-07-03-day-126.data';
import day127 from '@/content/briefs/2026-07-04-day-127.data';
import day128 from '@/content/briefs/2026-07-05-day-128.data';
import day129 from '@/content/briefs/2026-07-06-day-129.data';
import day130 from '@/content/briefs/2026-07-07-day-130.data';
import day131 from '@/content/briefs/2026-07-08-day-131.data';
import day132 from '@/content/briefs/2026-07-09-day-132.data';
import day133 from '@/content/briefs/2026-07-10-day-133.data';
import day134 from '@/content/briefs/2026-07-11-day-134.data';
import day135 from '@/content/briefs/2026-07-12-day-135.data';
import day136 from '@/content/briefs/2026-07-13-day-136.data';
import day137 from '@/content/briefs/2026-07-14-day-137.data';
import day138 from '@/content/briefs/2026-07-15-day-138.data';
import day139 from '@/content/briefs/2026-07-16-day-139.data';
import day140 from '@/content/briefs/2026-07-17-day-140.data';
import day141 from '@/content/briefs/2026-07-18-day-141.data';
import day142 from '@/content/briefs/2026-07-19-day-142.data';
import day143 from '@/content/briefs/2026-07-20-day-143.data';
import day144 from '@/content/briefs/2026-07-21-day-144.data';
import day145 from '@/content/briefs/2026-07-22-day-145.data';
import day146 from '@/content/briefs/2026-07-23-day-146.data';
import day147 from '@/content/briefs/2026-07-24-day-147.data';
import day148 from '@/content/briefs/2026-07-25-day-148.data';
import day149 from '@/content/briefs/2026-07-26-day-149.data';
import day150 from '@/content/briefs/2026-07-27-day-150.data';
import day151 from '@/content/briefs/2026-07-28-day-151.data';
import day152 from '@/content/briefs/2026-07-29-day-152.data';
import day153 from '@/content/briefs/2026-07-30-day-153.data';
import day154 from '@/content/briefs/2026-07-31-day-154.data';
import day155 from '@/content/briefs/2026-08-01-day-155.data';
import day156 from '@/content/briefs/2026-08-02-day-156.data';
import day157 from '@/content/briefs/2026-08-03-day-157.data';
import day158 from '@/content/briefs/2026-08-04-day-158.data';
import day159 from '@/content/briefs/2026-08-05-day-159.data';
...
import day164 from '@/content/briefs/2026-08-10-day-164.data';
import day165 from '@/content/briefs/2026-08-11-day-165.data';
import day166 from '@/content/briefs/2026-08-12-day-166.data';
import day167 from '@/content/briefs/2026-08-13-day-167.data';
import day168 from '@/content/briefs/2026-08-14-day-168.data';
import day169 from '@/content/briefs/2026-08-15-day-169.data';
import day170 from '@/content/briefs/2026-08-16-day-170.data';
import day171 from '@/content/briefs/2026-08-17-day-171.data';
import day172 from '@/content/briefs/2026-08-18-day-172.data';
import day173 from '@/content/briefs/2026-08-19-day-173.data';
import day174 from '@/content/briefs/2026-08-20-day-174.data';
import day175 from '@/content/briefs/2026-08-21-day-175.data';
import day176 from '@/content/briefs/2026-08-22-day-176.data';
import day177 from '@/content/briefs/2026-08-23-day-177.data';
import day178 from '@/content/briefs/2026-08-24-day-178.data';
import day179 from '@/content/briefs/2026-08-25-day-179.data';
import day180 from '@/content/briefs/2026-08-26-day-180.data';
import day181 from '@/content/briefs/2026-08-27-day-181.data';
import day182 from '@/content/briefs/2026-08-28-day-182.data';
import day184 from '@/content/briefs/2026-08-30-day-184.data';
import day185 from '@/content/briefs/2026-08-31-day-185.data';
import day186 from '@/content/briefs/2026-09-01-day-186.data';
import day187 from '@/content/briefs/2026-09-02-day-187.data';
import day188 from '@/content/briefs/2026-09-03-day-188.data';
import day189 from '@/content/briefs/2026-09-04-day-189.data';
import day190 from '@/content/briefs/2026-09-05-day-190.data';
import day191 from '@/content/briefs/2026-09-06-day-191.data';
import day192 from '@/content/briefs/2026-09-07-day-192.data';
import day193 from '@/content/briefs/2026-09-08-day-193.data';
import day194 from '@/content/briefs/2026-09-09-day-194.data';
import day195 from '@/content/briefs/2026-09-10-day-195.data';
import day196 from '@/content/briefs/2026-09-11-day-196.data';
import day197 from '@/content/briefs/2026-09-12-day-197.data';
import day198 from '@/content/briefs/2026-09-13-day-198.data';
import day199 from '@/content/briefs/2026-09-14-day-199.data';
import day200 from '@/content/briefs/2026-09-15-day-200.data';
import day201 from '@/content/briefs/2026-09-16-day-201.data';
import day202 from '@/content/briefs/2026-09-17-day-202.data';
import day203 from '@/content/briefs/2026-09-18-day-203.data';
import day204 from '@/content/briefs/2026-09-19-day-204.data';
import day205 from '@/content/briefs/2026-09-20-day-205.data';
import day206 from '@/content/briefs/2026-09-21-day-206.data';
import day208 from '@/content/briefs/2026-09-23-day-208.data';
...
const briefDataBySlug: Record<string, BriefData> = {
  ...
  '2026-07-01-day-124': day124,
  '2026-07-02-day-125': day125,
  '2026-07-03-day-126': day126,
  '2026-07-04-day-127': day127,
  '2026-07-05-day-128': day128,
  '2026-07-06-day-129': day129,
  '2026-07-07-day-130': day130,
  '2026-07-08-day-131': day131,
  '2026-07-09-day-132': day132,
  '2026-07-10-day-133': day133,
  '2026-07-11-day-134': day134,
  '2026-07-12-day-135': day135,
  '2026-07-13-day-136': day136,
  '2026-07-14-day-137': day137,
  '2026-07-15-day-138': day138,
  '2026-07-16-day-139': day139,
  '2026-07-17-day-140': day140,
  '2026-07-18-day-141': day141,
  '2026-07-19-day-142': day142,
  '2026-07-20-day-143': day143,
  '2026-07-21-day-144': day144,
  '2026-07-22-day-145': day145,
  '2026-07-23-day-146': day146,
  '2026-07-24-day-147': day147,
  '2026-07-25-day-148': day148,
  '2026-07-26-day-149': day149,
  '2026-07-27-day-150': day150,
  '2026-07-28-day-151': day151,
  '2026-07-29-day-152': day152,
  '2026-07-30-day-153': day153,
  '2026-07-31-day-154': day154,
  '2026-08-01-day-155': day155,
  '2026-08-02-day-156': day156,
  '2026-08-03-day-157': day157,
  '2026-08-04-day-158': day158,
  '2026-08-05-day-159': day159,
  '2026-08-06-day-160': day160,
  '2026-08-07-day-161': day161,
  '2026-08-08-day-162': day162,
  '2026-08-09-day-163': day163,
  '2026-08-10-day-164': day164,
  '2026-08-11-day-165': day165,
  '2026-08-12-day-166': day166,
  '2026-08-13-day-167': day167,
  '2026-08-14-day-168': day168,
  '2026-08-15-day-169': day169,
  '2026-08-16-day-170': day170,
  '2026-08-17-day-171': day171,
  '2026-08-18-day-172': day172,
  '2026-08-19-day-173': day173,
  '2026-08-20-day-174': day174,
  '2026-08-21-day-175': day175,
  '2026-08-22-day-176': day176,
  '2026-08-23-day-177': day177,
  '2026-08-24-day-178': day178,
  '2026-08-25-day-179': day179,
  '2026-08-26-day-180': day180,
  '2026-08-27-day-181': day181,
  '2026-08-28-day-182': day182,
  '2026-08-30-day-184': day184,
  '2026-08-31-day-185': day185,
  '2026-09-01-day-186': day186,
  '2026-09-02-day-187': day187,
  '2026-09-03-day-188': day188,
  '2026-09-04-day-189': day189,
  '2026-09-05-day-190': day190,
  '2026-09-06-day-191': day191,
  '2026-09-07-day-192': day192,
  '2026-09-08-day-193': day193,
  '2026-09-09-day-194': day194,
  '2026-09-10-day-195': day195,
  '2026-09-11-day-196': day196,
  '2026-09-12-day-197': day197,
  '2026-09-13-day-198': day198,
  '2026-09-14-day-199': day199,
  '2026-09-15-day-200': day200,
  '2026-09-16-day-201': day201,
  '2026-09-17-day-202': day202,
  '2026-09-18-day-203': day203,
  '2026-09-19-day-204': day204,
  '2026-09-20-day-205': day205,
  '2026-09-21-day-206': day206,
  '2026-09-23-day-208': day208,
